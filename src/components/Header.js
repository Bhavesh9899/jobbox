            ...
            <nav className="navbar navbar-expand-md">
                <div className="container-fluid container-fluid-navbar">
                    <NavLink to="/" className="navbar-brand">
                        <img src="/jobbox/image/logo.png" className='nav-logo' alt="logo image"/>
                        </NavLink>
                    ...
                    <div className="btn-container">
                        <NavLink to='/sign-in' className="btn btn-sm px-3 py-2 btn-primary btn-main btn-contact-md">Sign In</NavLink>
                    </div> 
                </div>
            </nav>
        </header>
